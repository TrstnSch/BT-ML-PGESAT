    ...
    \begin{tikzpicture}
        ...
        \begin{pgfonlayer}{background}
            ...
            \node[
                rotate=90, 
                anchor=center
            ] at ([xshift=-3mm]backgroundevaluation.west) {Downstream Model};
        \end{pgfonlayer}
...
\begin{tikzpicture}
    ...
    \node (node_emb_i1) [data] {$\mathbf{z}_i$};
    \node (node_emb_j1) [data, right=0.5cm of node_emb_i1] {$\mathbf{z}_j$};
    ...
    \node (node_emb_i2) [data, right=3cm of node_emb_j1] {$\mathbf{z}_i$};
    \node (node_emb_j2) [data, right=0.5cm of node_emb_i2] {$\mathbf{z}_j$};
    \node (node_emb_v2) [data, right=0.5cm of node_emb_j2] {$\mathbf{z}_v$};
    ...
    \begin{pgfonlayer}{background}
        \node[draw=gray, thick, rounded corners, fit=(node_emb_i1) (node_emb_j1) (edge_emb_ij), fill=olive!30, label=above:Graph Task] {};
    \end{pgfonlayer}
    
    \begin{pgfonlayer}{background}
        \node[draw=gray, thick, rounded corners, fit=(node_emb_i2) (node_emb_v2) (edge_emb_ijv), fill=violet!30, label=above:Node Task] {};
    \end{pgfonlayer}
\end{tikzpicture}
\caption[Visualization of edge embedding transformation]{TODO: FOR ALL EDGES IN $G_o$ Visualization of the edge embedding transformation used to create inputs for the explainer network. Depending on the downstream task used in the target model the created edge embeddings differ slightly.}
\label{fig:edge_emb_trans}
\end{figure}
...
\node (target) [module, below=of input] {Downstream Model};
...
\begin{figure}
    ...
    \begin{tikzpicture}
        ...
        \node (GraphConv) [function, right=3cm of H_1] {GraphConv};
        \node (ReLu) [function, below=0.1cm of GraphConv] {ReLu};
        \node (BN) [function, below=0.1cm of ReLu] {BatchNorm};
        \node (Dropout) [function, below=0.1cm of BN] {Dropout};
        ...
        \begin{pgfonlayer}{background}
            ...
            \node[
                rotate=90, 
                anchor=center
            ] at ([xshift=-3mm]backgroundevaluation.west) {Downstream Model Node Classification};
        \end{pgfonlayer}
        ...
        %\end{pgfonlayer}
    \end{tikzpicture}
    \caption{Visualization of the concrete node classification downstream model. concat denotes the row-wise concatenation along the feature dimension.}
\end{figure}
    ...
    \begin{tikzpicture}
        ...
        \begin{pgfonlayer}{background}
            ...
            \node[
                rotate=90, 
                anchor=center
            ] at ([xshift=-3mm]backgroundevaluation.west) {Downstream Model Graph Classification};
        \end{pgfonlayer}
        ...
        %\end{pgfonlayer}
    \end{tikzpicture}
    \caption{Visualization of the concrete graph classification downstream model.}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[t]{0.48\textwidth}
        ...
        \begin{tikzpicture}
            ...
            %\end{pgfonlayer}
        \end{tikzpicture}
        \caption{concat denotes row-wise concatenation along the feature dimension.}
        \label{fig:node-classification}
    \end{subfigure}
    \hfill
    \rule{0.4pt}{\linewidth}
    \hfill
