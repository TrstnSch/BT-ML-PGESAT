...
We adopt the MLP architecture described in Section \ref{sec:Replication_of_PGExplainer}, but also perfrom experiments with a more complex architecture (see Section \ref{sec:SAT-experiments}). Besides these changes, the explainer operates as previously explained.