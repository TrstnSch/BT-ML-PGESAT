...
\section{TODO Perturbation-based Explainability in GNNs}
...
In this work we focus on the perturbation-based approach, more specifically the PGExplainer, that aims to evaluate the change of prediction with respect to input perturbations. 
