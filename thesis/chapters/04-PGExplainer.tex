\chapter{PGExplainer - Main part - Methodology}
...
\section{TODO: Extension to application on NeuroSAT}
...
In the following, we provide the implementation details needed reproduce our results. This includes the general replication of the PGExplainer in section \ref{sec:Replication_of_PGExplainer} and the specifics for the adaptation on NeuroSAT in section \ref{sec:Application_to_NeuroSAT}.
