...
\begin{tikzpicture}
    ...
    \end{pgfonlayer}
\end{tikzpicture}
\caption[Visualization of edge embedding transformation]{TODO: UGLY AF! JUST REMOVE? FOR ALL EDGES IN $G_o$ Visualization of the edge embedding transformation used to create inputs for the explainer network. Depending on the downstream task used in the \ac{TM} the created edge embeddings differ slightly.}
...
\begin{figure}
    ...
    \begin{tikzpicture}
        ...
        %\end{pgfonlayer}
    \end{tikzpicture}
    \caption{Visualization of the concrete node classification target model. concat denotes the row-wise concatenation along the feature dimension.}
\end{figure}
...
\begin{figure}
    ...
    \begin{tikzpicture}
        ...
        %\end{pgfonlayer}
    \end{tikzpicture}
    \caption{Visualization of the concrete graph classification target model.}
\end{figure}
