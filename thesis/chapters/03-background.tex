...
Explain? Used in architecture of target model\\
Explain concrete layers used in original/replication and our version: \\

\textbf{Graph Convolutional Network} \\
Kipf et al.\cite{kipf2016semi}
multi-layer Graph Convolutional Network (GCN) with the following layer-wise propagation rule:
\begin{equation}
...
\end{equation}
$\hat{D}^{-\frac{1}{2}}\hat{A}\hat{D}^{-\frac{1}{2}}$ is a normalization of the adjacency matrix
